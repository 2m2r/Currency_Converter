...
import com.ghabiomar.retrofit_daggerhilt_mvvm.data.models.Rates
...
class MainViewModel @ViewModelInject constructor(
  ...
  private val dispatchers: DispatcherProvides
): ViewModel() {
  ...
  private fun  getRatesForCurrency (toCurrency :String , rates: Rates)=  when(toCurrency){
    "AED" -> rates.AED
    "AFN" -> rates.AFN
    "ALL" -> rates.ALL
    "AMD" -> rates.AMD
